...
@section('main')
    ...
    <section class="feature-area feature-area__2 grey-bg pt-125">
        <div class="container">
                    ...
                    <div class="feature-item feature-item__2">
                        ...
                        <div class="feature-item__content feature-item__content--2">
                            ...
                            <p>Dis duis auctor an cum vel enim felis proins parturient pot nostra tiyer an bold interect
                                pena</p>
                            <a href="service-details.html" class="inline-btn"><span class="icon"><i
    ...
    <!-- project section end -->
    <!-- news section start -->
    <section class="news-area news-area__2 pt-125 pb-125">
        <div class="container">
            <div class="row">
                <div class="col-xl-7">
                    <div class="section-header">
                        <h2 class="section-title section-title__2">Pembaruan Terbaru</h2>
                    </div>
                </div>
                <div class="col-xl-5 text-right news-right">
                    <a href="news.html" class="inline-btn"><span class="icon"><i
                                class="far fa-arrow-right"></i></span>
                        Go to blog</a>
                </div>
            </div>
            <div class="row mt-none-30">
                <div class="col-xl-6 col-lg-12 mt-30">
                    <article class="post-box">
                        ...
                        <div
                            ...
                            <a href="news-details.html" class="date-author">Creative / 12 nov 2020</a>
                            <h4 class="post-box__title post-box__title--2">
                                <a href="news-details.html">Magna nostra vitae pede pretium sceler
                                    isque nec turpis rhoncus</a>
                            </h4>
                            <a href="news-details.html" class="inline-btn mt-0">
                ...
                <div class="col-xl-6">
                    <article class="post-box">
                        <div class="row reverse-col flex-xs-column-reverse mt-30">
                            <div class="col-xl-6 col-lg-6 my-auto">
                                <div class="post-box__content post-box__content--2 post-box__content--white p-0">
                                    <a href="news-details.html" class="date-author">Creative / 12 nov 2020</a>
                                    <h4 class="post-box__title post-box__title--2">
                                    ...
                                    <a href="news-details.html" class="inline-btn">
                                        <span class="icon"><i class="far fa-arrow-right"></i></span>
                                        continue Reading
                                    </a>
                                </div>
