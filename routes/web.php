...
Route::get('/cot-teungoh', [cotteungeuhController::class, 'cotTeungoh']);
Route::get('/paloh-bugak', [palohbugakController::class, 'palohBugak']);
Route::get('/paloh-panyang', [palohpanyangController::class, 'palohPanyang']);
Route::get('/paloh-sawang', [palohsawangController::class, 'palohSawang']);
